    ...
    <div class="copyright_c">
      <div class="copyright_head">
        <div class="copyright_L">
          ...
          <span>
			<em>客服QQ：</em>
			<a href="#"style=" display: block; float: left; width:100px; height: 30px;border-radius: 3px; overflow: hidden; background: url(static/img/QQ.jpg) #03d3ff no-repeat 11px center;padding-left:35px; font-size: 14px; color: #FFF; line-height: 30px; margin-right:10px" >在线交谈</a>
		</span>
        </div>
        <div class="copyright_C">
